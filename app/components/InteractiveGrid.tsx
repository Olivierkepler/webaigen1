...
export default function InteractiveGrid() {
  ...
  // Smooth out the mouse movement (Lerping)
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* 1. THE "SCANNER" LINE: A vertical gold laser that follows the mouse */}
      <div 
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-center relative z-10">
        ...
        {/* Architectural Image with Advanced 3D Tilt */}
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden shadow-[20px_20px_50px_rgba(0,0,0,0.5)]">
               <img 
                ...
                style={{ transform: `scale(1.2) translate(${smoothMouse.x * -20}px, ${smoothMouse.y * -20}px)` }}
                alt="Brutalist Structure"
              />
            </div>

            {/* Floating HUD: Translates faster than the image for "Parallax Pop" */}
            <div 
              className="absolute -top-6 -right-6 p-6 bg-black/80 backdrop-blur-xl border border-white/10 z-20"
              style={{ transform: `translateZ(50px) translate(${smoothMouse.x * 30}px, ${smoothMouse.y * 30}px)` }}
            >
        ...
        <div className="md:col-span-6 space-y-12">
          ...
          <button className="relative px-8 py-4 overflow-hidden group">
