...
function useDecrypt(text: string, speedMs = 18, delayMs = 120) {
  ...
  const glyphs = useMemo(() => "XY01_<>[]?/~!@#%&*".split(""), []);
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* 3D Grid */}
      <div
        className="absolute inset-0 z-[1] [perspective:1000px] pointer-events-none"
        aria-hidden="true"
      >
        ...
        <div className="max-w-6xl">
          ...
          >
            ...
            <p className="max-w-xl font-sans text-sm sm:text-lg text-white/82 leading-relaxed drop-shadow-md">
              WebAiGen engineers high-performance interfaces and autonomous
              systems. We deploy production-ready intelligence that is{" "}
...
<SecondaryButton
  href="https://webaigensmallbusiness.vercel.app/"
>
