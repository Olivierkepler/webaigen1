          ...
          <div className="p-6 sm:p-8 flex flex-col h-full">
            ...
            <div className="mt-6">
              <button
                type="button"
                onClick={() => setTheme(isDark ? "light" : "dark")}
                className="w-full px-4 py-3 border border-white/10 hover:border-[#d4af37]/60 bg-white/[0.02] text-white/85 hover:text-[#d4af37] text-[0.7rem] font-montserrat tracking-[4px] uppercase transition-colors"
                aria-label={
                  mounted
                    ? `Switch to ${isDark ? "light" : "dark"} mode`
                    : "Toggle theme"
